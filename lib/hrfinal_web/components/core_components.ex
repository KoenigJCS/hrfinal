defmodule HrfinalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HrfinalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HrfinalWeb.Gettext, "errors", msg, opts)
    end
  end
